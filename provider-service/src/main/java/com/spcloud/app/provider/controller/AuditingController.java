...
import com.spcloud.app.provider.service.AuditingService;
...
public class AuditingController {
    ...
    @ApiOperation(value = "获取全部审核", httpMethod = "GET")
    @RequestMapping("/selectAll")
    public R<List<Auditing>> selectAll() {
        return auditingService.selectAll();
    }

    @ApiOperation(value = "根据条件筛选获取管理员列表，并分页", httpMethod = "POST")
    @RequestMapping("/selectPages")
    public R selectPages(@RequestBody Map<String, Object> req) {
        return auditingService.selectPages(req);
    }
    ...
    public R selectOperator(@RequestBody Map<String, Object> req) {
        return auditingService.selectPagesOperator(req);
    }
    ...
    public R findById(@RequestParam Integer id) {
        return auditingService.findById(id);
    }

    @ApiOperation(value = "根据id更新数据", httpMethod = "POST")
    @RequestMapping("/update")
    @ApiImplicitParam(name = "data", value = "使用json数据提交", type = "json", dataTypeClass = Auditing.class, paramType = "body")
    public R update(@RequestBody Map data) {
        Auditing post = BeanUtil.mapToBean(data, Auditing.class, true);
        return auditingService.update(post, data);
    }
    ...
    public R insert(@RequestBody Map data) {
        Auditing post = BeanUtil.mapToBean(data, Auditing.class, true);
        return auditingService.insert(post, data);
    }
    ...
    public R delete(@RequestBody List<Integer> id) {
        return auditingService.delete(id);
    }
}
