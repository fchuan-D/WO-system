...
import com.spcloud.app.provider.service.InformationService;
...
public class InformationController {
    ...
    @ApiOperation(value = "获取全部设备信息", httpMethod = "GET")
    ...
    public R selectPages(@RequestBody Map<String, Object> req) {
        return informationService.selectPages(req);
    }
    ...
    @ApiImplicitParam(name = "data", value = "使用json数据提交", type = "json", dataTypeClass = Information.class, paramType = "body")
    public R update(@RequestBody Map data) {
        Information post = BeanUtil.mapToBean(data, Information.class, true);
        return informationService.update(post, data);
    }
    ...
    public R insert(@RequestBody Map data) {
        Information post = BeanUtil.mapToBean(data, Information.class, true);
        return informationService.insert(post, data);
    }
