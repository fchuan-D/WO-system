...
import com.spcloud.app.provider.service.LogsService;
...
public class LogsController {
    ...
    @ApiOperation(value = "获取全部操作日志", httpMethod = "GET")
    ...
    public R selectPages(@RequestBody Map<String, Object> req) {
        return logsService.selectPages(req);
    }
    ...
    @ApiImplicitParam(name = "data", value = "使用json数据提交", type = "json", dataTypeClass = Logs.class, paramType = "body")
    public R update(@RequestBody Map data) {
        Logs post = BeanUtil.mapToBean(data, Logs.class, true);
        return logsService.update(post, data);
    }
    ...
    public R insert(@RequestBody Map data) {
        Logs post = BeanUtil.mapToBean(data, Logs.class, true);
        return logsService.insert(post, data);
    }
