...
import com.spcloud.app.provider.service.MaterialService;
...
public class MaterialController {
    ...
    @ApiOperation(value = "获取全部材料信息", httpMethod = "GET")
    ...
    public R selectPages(@RequestBody Map<String, Object> req) {
        return materialService.selectPages(req);
    }
    ...
    @ApiImplicitParam(name = "data", value = "使用json数据提交", type = "json", dataTypeClass = Material.class, paramType = "body")
    public R update(@RequestBody Map data) {
        Material post = BeanUtil.mapToBean(data, Material.class, true);
        return materialService.update(post, data);
    }
    ...
    public R insert(@RequestBody Map data) {
        Material post = BeanUtil.mapToBean(data, Material.class, true);
        return materialService.insert(post, data);
    }
