...
import com.spcloud.app.provider.service.PlanService;
...
public class PlanController {
    ...
    @ApiOperation(value = "获取全部作业计划", httpMethod = "GET")
    ...
    public R selectPages(@RequestBody Map<String, Object> req) {
        return planService.selectPages(req);
    }
    ...
    public R selectOpera(@RequestBody Map<String, Object> req) {
        return planService.selectPagesOpera(req);
    }
    ...
    @ApiImplicitParam(name = "data", value = "使用json数据提交", type = "json", dataTypeClass = Plan.class, paramType = "body")
    public R update(@RequestBody Map data) {
        Plan post = BeanUtil.mapToBean(data, Plan.class, true);
        return planService.update(post, data);
    }
    ...
    public R insert(@RequestBody Map data) {
        Plan post = BeanUtil.mapToBean(data, Plan.class, true);
        return planService.insert(post, data);
    }
